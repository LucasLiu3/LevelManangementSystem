...
namespace LevelManangementSystem.web.Controllers
{
    ...
    public class PeriodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,StartDay,EndDay,Id")] Period period)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,StartDay,EndDay,Id")] Period period)
        {
            if (id != period.Id)
            {
                return NotFound();
