...
namespace LevelManangementSystem.web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var roles = await  _roleManager.Roles.Select(each=> each.Name).Where(each=> each != "Admin").ToArrayAsync();
            RoleNames = roles;
        }
